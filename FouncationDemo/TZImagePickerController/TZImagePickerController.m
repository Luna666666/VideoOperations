...
- (void)viewDidLoad {
    ...
    [TZImageManager manager].uploadHighQuality = self.uploadHighQuality;
...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount Quailty:(BOOL)uploadQuailty  delegate:(id<TZImagePickerControllerDelegate>)delegate {
    self.uploadHighQuality = uploadQuailty;
