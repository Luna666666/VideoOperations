...
@interface TZPhotoPickerController ()<UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate,CustomVideoEditorDelegate> {
...
//            [self createEditorVC:nil];
//            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(getUrl:) name:@"video_url" object:nil];
//            [[TZImageManager manager] getVideoOutputPathWithAsset:nil completion:^(NSString *outputPath) {
...
//    NSLog(@"wefewfgwegfgwegf");
//    NSLog(@"地址%@",[noti object]);
//    [self createEditorVC:(NSString *)[noti object]];
//}

//编辑类
-(void)createEditorVC:(NSString *)outPutPath{
